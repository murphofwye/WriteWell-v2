...
const projectKey = "writing-pomodoro-projects";
...
function handleTimerEnd() {
  ...
  if (isWork) {
    ...
    // Break finished, advance to next sprint or finish session
    sprintIndex += 1;
...
// When word modal is closed, auto start break
...
function createProject(name) {
  ...
  projects[name] = {
    ...
    progress: { sprintWords: [], sprintIndex: 0, isWork: true }
  };
  currentProject = name;
  saveProjects();
  updateProjectSelect();
